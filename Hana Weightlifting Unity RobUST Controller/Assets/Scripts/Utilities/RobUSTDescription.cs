...
public sealed class RobUSTDescription
{
    ...
    private static readonly double3[] AllPulleyPositions = new double3[]
    {
        ...
        new double3(-0.554510179595532, 2.57998755330367, -0.97002440199618),  // 4: Front-Right Bottom (Motor 8)
        new double3(-0.532261584267422, 0.0650720717224675, -1.04365504073814),  // 5: Front-Left Bottom (Motor 7)
