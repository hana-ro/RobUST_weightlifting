...
public class DataLogger
{
    ...
    public struct DataFrame
    {
        ...
        public double4x4 EEPoseLRF;
        public double4x4 EEPoseRRF;
    ...
    /// Records individual left and right end-effector poses.
    /// </summary>
    ...
    public void WriteToDisk(string sessionName)
    {
        ...
        try 
        {
            using (StreamWriter writer = new StreamWriter(fullPath))
            {
                ...
                AppendMatrixHeader(sb, "EE_L");
                AppendMatrixHeader(sb, "EE_R");
